...
- **`../AGENTS.md`** — the invariants. Tokens stored hashed, org membership
...
- **`../../.agents/skills/riabuild-api/SKILL.md`** — before adding or changing an
  endpoint.
...
file in `src/` allowed to import from `convex/react` — see `../AGENTS.md` for
