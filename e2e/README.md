...
exactly
`claude_accounts,claude_trust,claude_onboarding,claude_agents_view,claude_bypass_consent,claude_codex_mcp`
outstanding and nothing else — the latter five each write into a profile directory
